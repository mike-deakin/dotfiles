 ...
 * [nvim] Migrate from Packer to Lazy.nvim ___Because___ packer is no longer maintained and is out of date.
 * [nvim] Find an alternative to caskey.nvim ___Because___ it has been archived and is now calling deprecated functions :(
 ...
 * [nvim] Write functions to go to/from test files ___Because___ I miss that feature from IDEA
