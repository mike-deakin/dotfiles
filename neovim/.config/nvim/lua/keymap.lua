...
ck.setup({
	...
	},
	{
		...
		['<C-j>'] = { act = ck.cmd 'cnext', desc = 'Quickfix: next' },
		['<C-k>'] = { act = ck.cmd 'cprev', desc = 'Quickfix: prev' },
	},
	{
		mode = 'n',
	...
	['<leader>'] = {
		...
		['f'] = function()
			...
			return {
				...
				['o'] = { act = function() tb.git_files({ show_untracked = true }) end, desc = 'Find files in git, including untracked' },
